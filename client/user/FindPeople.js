// To display the who to follow feature, we will create a component called FindPeople, which can be added to any of the views or rendered on its own.
...
export default function FindPeople() {
    ...
    useEffect(() => {
        ...
        // We will fetch the users not being followed by calling the findPeople method in useEffect
        findPeople({
            userId: jwt.user._id
        }, {
                t: jwt.token
    ...
    return (<div>
        <Paper className={classes.root} elevation={4}>
            ...
            {/* The fetched list of users will be iterated over and rendered in a Material-UI List component, with each list item containing the user's avatar, name, 
            a link to the profile page, and a Follow button*/}
            <List>
        ...
        following this new user. Snackbar will display the message containing the followed user's name at the bottom-right corner of the page, and then auto-hide it

/* We chose to display the FollowGrid components in tabs within the Profile component. We created a separate ProfileTabs component using Material-UI tab components 
and added that to the Profile component. This ProfileTabs component contains the two FollowGrid components with following and followers lists, along with a PostList component
that shows the posts by the user.
*/
